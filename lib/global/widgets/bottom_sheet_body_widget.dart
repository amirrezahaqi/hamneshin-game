  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: const Border(top : BorderSide(color: UiColors.lightBlueColor4,width: 3)),
          boxShadow: [
...
Future<dynamic> buildShowCustomModalBottomSheet({required BuildContext context,required Widget Function(BuildContext context) builder}) {
